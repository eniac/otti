...
genPath ctx path = do
    m <- loadMain path
    let r :: (Ctx (Prime 21888242871839275222246405745257275088548364400416034343698204186575808495617)) = genMainCtx m 21888242871839275222246405745257275088548364400416034343698204186575808495617
