...
zTests = benchTestGroup
  ...
  , bothTest "data-if"         "main" "test/Code/Zokrates/data_if.zok"
    $ M.fromList [("x", 1), ("y", 2), ("z", 3)]
  , bothTest "data-if (false)" "main" "test/Code/Zokrates/data_if.zok"
    $ M.fromList [("x", 0), ("y", 2), ("z", 3)]
  , bothTest
      "mux3"
      "main"
