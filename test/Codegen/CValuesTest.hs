...
cValueTests = benchTestGroup
  ...
  , constraintValueTest "global" "foo" "test/Code/C/global.c" [ ("f0_foo__return_v0", i 4) ]
  , constraintValueTest "global" "bar" "test/Code/C/global.c" [ ("f0_bar__return_v0", i 15) ]
...
--  , constraintValueTest "memory 1" "test/Code/C/memory_1.c" [ ("f0_foo__return_v0", 100) ] -- Again, not sure what we want to do here. UC symex vs not UC symex?
  ...
  , constraintValueTest "array 0" "main" "test/Code/C/array.c" [ ("f0_main__return_v0", i 1) ]
  , constraintValueTest "array 1" "main" "test/Code/C/array_1.c" [ ("f0_main__return_v0", i 17) ]
  , constraintValueTest "array 2" "main" "test/Code/C/array_2.c" [ ("f0_main__return_v0", i 17) ]
...
cPequinTests = benchTestGroup
  ...
  [ constraintValueTest "base 2 log" "main" "test/Code/C/base_2_log.c" [ ("f0_main__return_v0", i 8) ]
  , constraintValueTest "sha1" "main" "test/Code/C/sha1.c" [ ]
  , constraintValueTest "sqrt" "main" "test/Code/C/sqrt.c" [ ("f0_main__return_v0", i 3) ]
  ]
