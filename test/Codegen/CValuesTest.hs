...
--  , constraintValueTest "memory 1" "test/Code/C/memory_1.c" [ ("f0_foo__return_v0", 100) ] -- Again, not sure what we want to do here. UC symex vs not UC symex?
  ...
  , constraintValueTest "char -> int" "char_to_int" "test/Code/C/casts.c" [ ("f0_char_to_int__return_v0", 0) ]
  , constraintValueTest "uint -> uchar" "unsigned_to_uchar" "test/Code/C/casts.c" [ ("f0_unsigned_to_uchar__return_v0", 255) ]
  ]
