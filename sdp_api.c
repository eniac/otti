...
/*
	...
	Vector sym_vectorize(Matrix A){
	  Big_Vector v = {(A.rows * (A.rows+1))/2,{0}};
  ...
  Matrix LA = {L.rows,L.cols,{0}};
  Matrix UA = {L.rows,L.cols,{0}};
  Matrix PA = {L.rows,L.cols,{0}};
  int n = L.rows;
 ...
 //Matrix_List LU_List = LUP_decompose(LT);
  Matrix LB = {L.rows,L.cols,{0}};
  Matrix UB = {L.rows,L.cols,{0}};
  Matrix PB = {L.rows,L.cols,{0}};
      ...
      int loop = 0;
        ...
        //print_mat(L);
	     ...
	     for (int id=0; id<U.rows*U.cols; id++){
	      ...
	      Big_Matrix QQ = {N*N,M,{0}};
	      Matrix nX = {N,N,{0}};//scal_mul(Q.X,-1);
        ...
        //print_mat_b(R);
	      ...
	      Big_Matrix LL = {(QQ.rows + R.rows),(N*N + QQ.cols),{0}};
          //prepend identity matrix to Q
        ...
        Big_Matrix LD = {LL.rows,LL.cols,{0}};
        Big_Matrix UD = {LL.rows,LL.cols,{0}};
        Big_Matrix PD = {LL.rows,LL.cols,{0}};
        int n = LL.rows;
        ...
        //Big_Matrix LLp = mat_mul_big(PD,LL);
        Big_Matrix LLp = {PD.rows,LL.cols,{0}};
        ...
        Big_Matrix I = {LL.rows,LL.cols,{0}};
        ...
        //Big_Matrix LU = mat_sub_big(mat_add_big(LD,UD),I);
        Big_Matrix LU = {LD.rows,LD.cols,{0}};
        ...
        //if (err <= 1e-2){
          ...
          if (stop > 0.25){
            ...
            Matrix XaD = {N,N,{0}};//mat_add(Q.X,scal_mul(D,alpha));
      ...
      loop = 0;
        ...
        //print_mat(Q.X);
	     ...
	     for (int id0=0; id0<U0.rows*U0.cols; id0++){
	      ...
	      Big_Matrix QQ0 = {N*N,M,{0}};
	      Matrix nX0 = {N,N,{0}};//scal_mul(Q.X,-1);
        ...
        for (int i = 0; i < M; i++){
	      ...
	      Big_Matrix LL0 = {(QQ0.rows + R0.rows),(N*N + QQ0.cols),{0}};
              //prepend identity matrix to Q
            ...
            //Big_Vector z = LUP_solve(LL, e);
            //Big_Matrix_List LU_List = LUP_decompose_big(LL);
			      Big_Matrix LD0 = {LL0.rows,LL0.cols,{0}};
			      Big_Matrix UD0 = {LL0.rows,LL0.cols,{0}};
			      Big_Matrix PD0 = {LL0.rows,LL0.cols,{0}};
			      int n0 = LL0.rows;
			      ...
			      for (int ld0=0; ld0<n0;ld0++){
			        ...
			        if (max_j0 != yd0){
			          ...
			          for (int sr0 = 0; sr0 < PD0.cols; sr0++){
						...
						//Big_Matrix LLp = mat_mul_big(PD,LL);
			      Big_Matrix LLp0 = {PD0.rows,LL0.cols,{0}};
			      ...
			      for (int vll0 = 0; vll0 < PD0.rows; ++vll0) {
			          for (int jll0 = 0; jll0 < LL0.cols; ++jll0) {
						...
						Big_Matrix I0 = {LL0.rows,LL0.cols,{0}};
			      ...
			      // end decomp
						...
						//Big_Matrix LU = mat_sub_big(mat_add_big(LD,UD),I);
						Big_Matrix LU0 = {LD0.rows,LD0.cols,{0}};
